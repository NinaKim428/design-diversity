...
## 레이아웃 / 그리드
- 콘텐츠 최대 폭: `1180px`. 좌우 패딩 모바일 24px / 데스크탑 56px.
...
## 컴포넌트
- **헤더/내비:** 높이 72px, 크림 배경. 좌측 워드마크(Fraunces 500), 중앙 메뉴(Inter 500), 우측 코랄 솔리드 알약 CTA. 내비 자체가 둥근 알약 컨테이너에 담길 수 있음.
- **알약 모듈 카드:** 가로로 긴 알약 또는 둥근 카드, 흰 표면. 안에 라운드 라인 아이콘 + 키커 + Fraunces 제목 + Inter 본문.
- **궤도 장식:** 코랄·앰버 알약 도형이 섹션 배경에 겹쳐 떠서 느리게 회전.
- **로고월:** 알약 컨테이너 안에 로고를 담아 가로 스크롤 또는 그리드.
